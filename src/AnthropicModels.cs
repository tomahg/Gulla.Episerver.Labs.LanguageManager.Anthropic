namespace Gulla.Episerver.Labs.LanguageManager.Anthropic
{
    ...
    public static class AnthropicModels
    {
        ...
        /// Does NOT support the temperature option (requests including temperature return HTTP 400).
        /// </summary>
        ...
        /// <summary>
        /// Claude Sonnet 4.6 — strong balance of speed and quality. Supports the temperature option.
        /// </summary>
        public const string ClaudeSonnet4_6 = "claude-sonnet-4-6";

        /// <summary>
        /// Claude Sonnet 4.5. Supports the temperature option.
        /// </summary>
        public const string ClaudeSonnet4_5 = "claude-sonnet-4-5";

        /// <summary>
        /// Claude Haiku 4.5 — fastest and most cost-effective. Supports the temperature option.
